...
#include "KhepriRightCuboid.generated.h"

/**
 * 
 */
UCLASS()
class BUTTONEXAMPLE_API UKhepriRightCuboid : public UEditorBrushBuilder
{
public:
	GENERATED_BODY()
public:
	UKhepriRightCuboid(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
