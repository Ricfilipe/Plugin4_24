...
RpiService::RpiService() {
    ...
    acceptor = new boost::asio::ip::tcp::acceptor(io_service, boost::asio::ip::tcp::endpoint(boost::asio::ip::tcp::v4(), 11009));
    socket_stream = new     binary_stream::BinaryStream(io_service, binary_stream::Endianess::kLittle);
}
